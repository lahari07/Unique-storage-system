...
public class Test {
	public static void main(String[] args) {
        ...
        aListOfAddresses.add(  new Address(1, "A", "B", "C", 500011) );
        aListOfAddresses.add(  new Address(2, "A", "B", "C", 500009) );
		...
		System.out.println( "-------------------------------------------------------" );
		System.out.println( "The addresses are sorted based on their House Numbers: "  + "\n");
        System.out.println(aListOfAddresses);
		System.out.println( "-------------------------------------------------------" );
		System.out.println( "The albums are sorted based on their release year: " + "\n");
